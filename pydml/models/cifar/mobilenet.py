"""
MobileNetV2 for CIFAR datasets.

Adapted from the original MobileNetV2 paper for CIFAR-10/100.
"""
...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=10, width_mult=1.0):
        ...
        # CIFAR configuration (adapted from ImageNet)
        ...
        interverted_residual_setting = [
            ...
            [6, 64, 4, 2],
            [6, 96, 3, 1],
            [6, 160, 3, 1],  # Changed stride from 2 to 1 for CIFAR
            [6, 320, 1, 1],
        ]
        ...
        self.features = [nn.Sequential(
            nn.Conv2d(3, input_channel, 3, 1, 1, bias=False),  # Changed stride from 2 to 1
