...
def demo_confidence_weighted():
    ...
    models = [resnet32(num_classes=10), wrn_28_10(num_classes=10)]
...
def compare_methods():
    ...
    results = compare_standard_vs_confidence_weighted(
        models_standard, models_weighted, train_loader, test_loader, epochs=30
    )
    ...
    plt.plot(
        results["weighted_history"]["avg_acc"], label="Confidence-Weighted", linewidth=2
    )
